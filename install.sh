...
echo ""
echo -e "${BLUE}============================="
echo -e "${GREEN}==== Instalacion General ===="
echo -e "${BLUE}============================="
echo ""
...
echo -e "${RESET}"
sudo -u fuis18 bash -c 'paru -S lf ueberzugpp wlogout scrub cmatrix-git yofi-bin'


echo ""
echo -e "${GREEN}=== yay's Dependencies ==="
echo -e "${RESET}"
sudo -u fuis18 bash -c 'yay -S librewolf swayimg'
